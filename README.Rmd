...
granular_base %>% 
  dplyr::filter(is_swap_in == TRUE) %>% 
  dplyr::select(id, old_score, new_score, stage_pass_credit_decision, stage_pass_anti_fraud, new_approval, simulated_pd, simulated_default) %>%
  head()
```
